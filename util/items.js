...
module.exports = {
  ...
  47: {
    ...
    description: '在賭博中失利時會獲得的印章，累積越多枚印章可以提高下次贏得獎勵的機率。單次投注達 50 點換取一枚、達 500 點換取兩枚，在拉霸機贏得獎勵或是在骰子遊戲中贏得雙倍賭注時會全數回收。',
    maxStack: 1000,
    value: 1
  },
  48: {
    ...
    description: '強化裝備失敗時會獲得的印章，累積越多枚印章可以提高下次強化成功的機率，強化成功時會全數回收。',
    maxStack: 1000,
    value: 1
  }
}
